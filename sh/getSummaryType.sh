...
# @brief: print summary-type
# @detail: This script checks whether a given file contains a line like `summary-type: summary` and returns the value specified for summary-type via stderr.
