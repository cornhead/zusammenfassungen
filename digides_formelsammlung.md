...
Wahrscheinlichkeit für Verletzung des Set-Up & Hold-Windows: $P_{violate} = \frac{T_0}{T_{clk}} \gt 0$
...
Arrhenius-Gleichung: Fehlerrate $F = C \cdot exp\left(-\frac{E_{act}}{k\cdot T}\right) \approx MTTF^{-1}$